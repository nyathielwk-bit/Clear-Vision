export const PACKAGES = [
  ...
  },
  {
    ...
    features: [
      ...
      "Extra landing / service pages",
      "Deeper SEO structure",
      "Stronger trust & proof sections",
...
export const CARE = [
  {
    ...
    unit: "/mo",
    features: [
      "Fast, secure hosting handled for you",
      "Software & security updates",
      "Weekly backups + uptime monitoring",
      "Up to 30 min of edits / month",
    ],
  },
  {
    name: "Plus Care",
...
export const FAQS = [
  [
    ...
    "Launch Pages go live in about three business days. Business Websites are typically ready in five to seven business days once we have your content and photos.",
  ],
  [
    "Do I need to write all the content?",
    "No. We guide you with a simple brief and can polish or write your copy as part of the project, so you are never staring at a blank page.",
  ],
  [
    "Will my site work well on phones?",
    "Always. Every site is built mobile-first and tested across phones, tablets, and the major browsers before launch.",
  ],
  [
    "Can you help me get found on Google?",
    "Yes. Every package includes basic SEO and analytics setup. Business and Growth Websites add local SEO and a deeper, search-ready structure.",
  ],
  [
    "How does payment work?",
    "Launch Pages are 100% upfront. Business and Growth Websites are 50% upfront and 50% before launch. You always get a fixed quote before any work begins.",
  ],
  [
    "What about hosting and upkeep?",
    "We set you up on fast, secure infrastructure and offer simple monthly Care plans for hosting, updates, and edits — so your site stays current without you lifting a finger.",
  ],
];
